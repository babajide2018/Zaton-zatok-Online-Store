            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse navigation-holder">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children has-mega-menu current-menu-parent">
                            <a href="#">Shop</a>
                            <ul class="mega-menu">
                                <li>
            ...
            <div class="row">
                <div class="col col-xs-12">
                    <div class="woocommerce">
                        <form action="https://products.wp-ts.com/" method="post">
                            <table class="shop_table shop_table_responsive cart">
                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        <a href="#">
                                            <img width="57" height="70" src="assets/images/cart/img-1.jpg"
                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        <a href="#">
                                            <img width="57" height="70" src="assets/images/cart/img-2.jpg"
                                                 class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="#"  />
                                        </a>
                                    </td>
